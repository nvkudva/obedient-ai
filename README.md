...
A Claude Code plugin marketplace with one plugin, `obedient-ai`, which loads a
...
[`obedient-ai/context/rules.md`](obedient-ai/context/rules.md) — edit that
...
[`obedient-ai/skills/linkedin-post/SKILL.md`](obedient-ai/skills/linkedin-post/SKILL.md).
...
`/plugin install obedient-ai@obedient-ai`.
...
4. Find **obedient-ai** in the list and toggle it **on**.
